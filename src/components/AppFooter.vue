      ...
      <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
        ...
        <div class="flex my-4">
          ...
          <div class="block pl-0 ml-auto min-h-6">
            <input
              type="checkbox"
              class="rounded-10 h-5 relative float-left mt-1 ml-auto w-10 cursor-pointer border border-solid border-gray-200 bg-slate-800/10 transition-all after:absolute after:top-px after:h-4 after:w-4 after:translate-x-px after:bg-white checked:border-blue-500/95 checked:bg-blue-500/95"
              v-model="navbarFixed"
            />
          </div>
        </div>
        ...
        <a
          ...
          class="inline-block w-full px-6 py-2.5 mb-4 font-bold leading-normal text-center text-white transition-all bg-gradient-to-tl from-zinc-800 to-zinc-700 rounded-lg shadow-md"
          >Free Download</a
        >
        <a
          target="_blank"
          href="https://www.creative-tim.com/learning-lab/tailwind/html/quick-start/argon-dashboard/"
          class="inline-block w-full px-6 py-2.5 mb-4 font-bold leading-normal text-center border border-slate-700 text-slate-700 rounded-lg hover:shadow-xs"
        ...
        <div class="w-full text-center">
          ...
          <a
            href="https://twitter.com/intent/tweet?text=Check%20Argon%20Dashboard..."
            target="_blank"
            class="inline-block px-5 py-2.5 mb-0 mr-2 font-bold text-center text-white bg-slate-700 rounded-lg hover:-translate-y-px"
...
function sidebarColor(color: string) {
  console.log('Sidebar color changed to:', color)
}

function setSidebarType(type: string) {
